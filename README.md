...
- In Docker Compose you can update all used images simply by running `docker compose pull`. but seems this does not update images that are used as volume mount(`type: image`). tested in Docker Compose version 2.39.2
